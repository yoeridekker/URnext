<?php
/**
 * The left sidebar template for displaying page/post content
 *
 * Used on template-left-sidebar.php
 *
 * @package URnext
 * @since URnext 1.0.0
 *
...
<div class="container">
    <div class="row">
        ...
        <!-- primary-sidebar -->
        <aside id="sidebar" class="wow textadjust slideInRight col-lg-3 text-color right-sidebar widget-area" role="complementary">
        ...
        <div class="wow slideInLeft col-lg-9 text-color">
