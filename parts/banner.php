...
if( is_front_page() ): 
    ...
    $style = sprintf('background-image:url(%s)', get_header_image() );?>
    

    <!-- start banner -->
    <div id="banner" class="content-panel home bg-header-color has-banner" data-section-name="top" style="<?php echo $style; ?>;">
        ...
        <div class="ontop container as-table inset-content full-height">
            <div class="row as-row full-height">
                <div class="col-md-12 as-cell full-height centered header-text-color">
                    <h1 class="heading-font underline wid after-header-text-color wow fadeIn header-text-color light-weight headadjust" data-wow-duration="0.6s" data-wow-delay="0.3s">
                        <?php the_title(); ?>
                    </h1>
                </div>
            </div>
