<?php
/**
 * This template will produce a template with no margins and paddings
 * The content is stretched over the complete window width
 *
...
<article class="content-panel" id="main-content">
    <?php while ( have_posts() ) : the_post(); ?>
        <?php get_template_part( 'parts/'. get_post_type().'/content', 'stretched'); ?>
        <div class="clear"></div>
    <?php endwhile; ?>
</article>
