...
$class      = '';
$layout     = (int) get_urnext_option('grid_layout_woocommerce') === 1 ? 'grid' : 'list' ;
...
<article class="<?php echo urnext_grid_column_classes(3,'grid_column_count_woocommerce','grid_column_margin_woocommerce'); ?> border-page-color grid-item <?php echo $class;?>" style="<?php echo $style; ?>">
